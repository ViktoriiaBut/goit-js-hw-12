import{a as u,S as p,i as m}from"./vendor-u8rapaCG.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();const d="46313967-d4d30fae59777882921d7e8bb",f=t=>{u.get("https://pixabay.com/api/",{params:{key:d,q:searchInput,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:9}}).then(o=>{if(!o.ok)throw new Error("Error fetching images");return o.json()}).then(o=>o.hits)},y=new p(".gallery a"),g=t=>{const o=document.querySelector(".gallery");if(o.innerHTML="",t.length===0){m.error({title:"Error",message:"Sorry, there are no images matching your search query. Please try again!"});return}const s=t.map(({webformatURL:a,largeImageURL:e,tags:r,likes:n,views:i,comments:l,downloads:c})=>`
...
//# sourceMappingURL=main-j-m0z5dx.js.map
